...
use backend::{close_session, create_session, get_json, get_session_status as backend_session_status, submit_text_turn, submit_voice_turn, wait_healthy, BackendProcessManager};
use serde_json::json;
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![start_backend, stop_backend, health_check, get_readiness, get_session_status, submit_text, submit_voice])
        .setup(|app| {
            setup_tray(app)?;
            Ok(())
        })
