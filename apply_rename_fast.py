    ...
    for f in files:
        if f.endswith('.py'):
            ...
            for old, new in replacements.items():
                # We need to make sure we are not replacing SessionResourceDiedError with SessionResourceDiedErrorError
                # since we might have run this script partially.
                if old + "Error" not in text:
